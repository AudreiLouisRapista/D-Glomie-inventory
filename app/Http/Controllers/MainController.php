...
//  dd(DB::table('schedules')->first());
   $view_grade2 = DB::table('schedules')
    ...
    $view_grade3 = DB::table('schedules')
        ->leftJoin('teacher', 'schedules.teachers_id', '=', 'teacher.teachers_id')
        ->Join('subject', 'schedules.subject_id', '=', 'subject.subject_id')
        ->where('schedules.grade_id', 9)
        ->select(
            'subject.subject_name as sub_name',
            'teacher.name as teacher_name',
            'schedules.sub_date',
        ...
        ->get();
         ...
         $view_grade4 = DB::table('schedules')
        ->leftJoin('teacher', 'schedules.teachers_id', '=', 'teacher.teachers_id')
        ->Join('subject', 'schedules.subject_id', '=', 'subject.subject_id')
        ->where('schedules.grade_id', 10)
        ->select(
            'subject.subject_name as sub_name',
            'teacher.name as teacher_name',
            'schedules.sub_date',
        ...
        ->get();
         ...
         $view_grade5 = DB::table('schedules')
        ->leftJoin('teacher', 'schedules.teachers_id', '=', 'teacher.teachers_id')
        ->Join('subject', 'schedules.subject_id', '=', 'subject.subject_id')
        ->where('schedules.grade_id', 11)
        ->select(
            'subject.subject_name as sub_name',
            'teacher.name as teacher_name',
            'schedules.sub_date',
        ...
        ->get();
         ...
         $view_grade6 = DB::table('schedules')
        ->leftJoin('teacher', 'schedules.teachers_id', '=', 'teacher.teachers_id')
        ->Join('subject', 'schedules.subject_id', '=', 'subject.subject_id')
        ->where('schedules.grade_id', 12)
        ->select(
            'subject.subject_name as sub_name',
            'teacher.name as teacher_name',
            'schedules.sub_date',
...
public function view_section() {
 ...
 return view('product', compact('view_section'));
...
//   dd($request->all(), $request->file());
    ...
    $check_exist = DB::table('teacher')->where('name', $name)->exists();
    if ($check_exist) {
    ...
    DB::table('teacher')->insert([
        ...
        'role'          => $role,
      'profile' => 'dist/img/avatar.png', // Now this variable exists!
    ]);

    // 5. Create Activity Log
    $this->logActivity('added', 'Added Teacher for Name: ' . $name);
...
public function view_schedule() {
    ...
    return view('inventory', compact('view_schedule', 'subject', 'teachers', 'section', 'school_year', 'grade'));
}
